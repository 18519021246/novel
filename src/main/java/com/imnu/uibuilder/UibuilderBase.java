...
public abstract class UibuilderBase<T>{
	...
	public UibuilderBase(String lanmuclassname,String textfieldname,String imagefieldname,String contextPath){
	  this.lanmuclassname=lanmuclassname;
	...
	public  String buildImageLanmu(String filter,int topCount,String  lanmudes){
		...
		try {
			list=simpleDao.query(sql, new BeanListHandler(getEntityClass()));
	...
	public String buildImageLanmu(List list,String lanmudes )
	{
		...
		for(Iterator iterator = list.iterator();iterator.hasNext();){
		  ...
		  sb.append(MessageFormat.format("<img src=\"{0}{1}\"/> ",contextPath,imagefieldvalue));
		  sb.append("</a>");
		  sb.append("\r\n");
